    ...
    @foreach ($jadwalHarian as $hari)
        <div @if (!$loop->last) style="page-break-after: always;" @endif>
            ...
            <div class="mt-6 text-center">
                <p class="font-display text-lg font-bold uppercase tracking-wide text-ink-900">Daftar Hadir Peserta</p>
            ...
            <table class="mt-6 w-full border-collapse text-sm">
                <thead>
                    <tr class="border-b-2 border-ink-900 text-left text-xs font-semibold uppercase tracking-wide text-ink-900">
                        ...
                        <th class="w-40 py-2.5">Tanda Tangan</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="py-6 text-center text-ink/50">Belum ada peserta terdaftar untuk kegiatan ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>

            <p class="mt-4 text-xs text-ink/45">Lembar ini khusus kehadiran {{ $hari['label'] }} ({{ $hari['tanggal_format'] }}); diisi manual oleh peserta saat check-in.</p>
