...
@section('content')
    ...
    <div class="mt-6 grid gap-4 sm:grid-cols-3">
        @php
            $dokumen = [
                ['label' => 'Daftar Peserta', 'desc' => 'Rekap semua peserta terdaftar per kegiatan.', 'target' => route('admin.cetak.daftar-peserta.preview'), 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/>'],
                ['label' => 'Daftar Hadir', 'desc' => 'Lembar tanda tangan kehadiran hari-H.', 'target' => route('admin.cetak.daftar-hadir.preview'), 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.75h-.152c-3.196 0-6.1-1.248-8.25-3.286z"/>'],
                ['label' => 'Daftar Penerimaan Konsumsi & ATK', 'desc' => 'Bukti tanda terima konsumsi dan ATK peserta.', 'target' => route('admin.cetak.konsumsi-atk.preview'), 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z"/>'],
            ];
        @endphp
    ...
    <script>
        // ikutkan kegiatan yang dipilih sebagai query param saat pindah ke halaman preview
