...
<body class="bg-canvas font-body text-ink antialiased">
    ...
    <div class="no-print sticky top-0 z-10 flex items-center justify-between border-b border-line bg-white px-5 py-3 sm:px-8">
        <a href="@yield('kembali_url', route('admin.cetak.index'))" class="flex items-center gap-1.5 text-sm font-medium text-ink/60 hover:text-ink-900">
        ...
        <div class="flex items-center gap-2">
            @hasSection('unduh_url')
                <a href="@yield('unduh_url')" class="inline-flex items-center gap-2 rounded-full border border-line px-5 py-2.5 text-sm font-semibold text-ink-900 hover:bg-ink-900/5">
