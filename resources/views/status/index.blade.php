{{--
    ...
    Route: GET /cek-status  (route name: cek-status)
    Controller mengirim salah satu dari kondisi berikut ke view:
    - $pendaftaran = null, $dicari = false   → belum ada pencarian (kunjungan pertama)
    - $pendaftaran = null, $dicari = true    → nomor dicari tapi tidak ketemu
    - $pendaftaran = object, $dicari = true  → ketemu, tampilkan status
                ...
                <div class="rounded-2xl border border-line p-5 sm:p-7">
                    <div class="flex flex-wrap items-center justify-between gap-3">
                        <div>
                            ...
                            <p class="mt-0.5 font-mono text-sm font-semibold text-ink-900">{{ $pendaftaran->nomor_pendaftaran }}</p>
                        </div>
