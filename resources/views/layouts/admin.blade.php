...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600;700;800&family=Plus+Jakarta+Sans:ital,wght@0,400;0,500;0,600;0,700;1,500&family=JetBrains+Mono:wght@400;500&display=swap"
        rel="stylesheet"
    >
...
<body class="bg-canvas text-ink font-body antialiased">
    ...
    <div class="flex min-h-screen">
        ...
        <div
            id="sidebar-overlay"
            class="fixed inset-0 z-30 hidden bg-ink-900/40 lg:hidden"
        ></div>
        ...
        <aside
            id="admin-sidebar"
            class="fixed inset-y-0 left-0 z-40 w-64 -translate-x-full overflow-y-auto
                   bg-ink-900 transition-transform duration-200
        ...
        >
            ...
            <div class="flex h-16 items-center gap-2.5 border-b border-white/10 px-5">
                ...
                @if ($globalSetting->logo_url)
                    ...
                    <img
                        ...
                        alt="{{ $globalSetting->nama_aplikasi }}"
                ...
                @else
                    ...
                    <span
                        class="flex h-9 w-9 shrink-0 items-center justify-center
                               rounded-lg bg-gold font-display text-sm font-bold text-ink-900"
                    >
                ...
                <div class="leading-tight">
                    ...
                    <p class="font-display text-sm font-bold text-canvas">
                        {{ $globalSetting->nama_aplikasi }}
                    </p>

                    <p class="text-[11px] text-canvas/45">
                        Panel Admin
                    </p>
                ...
                @php
                    ...
                    $menu = [
                        ...
                        [
                            'href' => '/admin/peserta',
                            'label' => 'Data Peserta',
                            'match' => 'admin/peserta$|admin/peserta\?.*',
            ...
            <div class="absolute inset-x-0 bottom-0 border-t border-white/10 p-3">
                ...
                <form action="/admin/logout" method="POST">
                    ...
                    <button
                        type="submit"
                        class="flex w-full items-center gap-3 rounded-xl px-3.5 py-2.5
                               text-sm font-medium text-canvas/55 transition
                               hover:bg-white/5 hover:text-canvas"
                    >
        ...
        <div class="min-w-0 flex-1">
            ...
            {{-- HEADER --}}
            <header
                class="sticky top-0 z-20 flex h-16 items-center gap-3
                       border-b border-line bg-white/90 px-5 backdrop-blur sm:px-6"
            >
                ...
                <button
                    ...
                    class="flex h-9 w-9 items-center justify-center
                           rounded-lg border border-line lg:hidden"
                    aria-label="Buka menu"
                >

                    <svg
                        class="h-5 w-5 text-ink-900"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        stroke-width="1.8"
                ...
                {{-- PAGE TITLE --}}
                <h1 class="font-display text-sm font-semibold text-ink-900 sm:text-base">
                ...
                <div class="ml-auto flex items-center gap-2.5">
                    ...
                    <a
                        ...
                        class="flex items-center gap-2.5 rounded-lg px-2 py-1.5
                               transition hover:bg-ink-900/[0.04]"
                    >

                        <span
                            class="flex h-8 w-8 items-center justify-center
                                   rounded-full bg-ink-900/[0.06]
                                   text-xs font-semibold text-ink-900"
                        >
                            {{ strtoupper(substr($adminLogin->name, 0, 1)) }}
                        </span>

                        <span class="hidden text-sm font-medium text-ink-900 sm:inline">
                            {{ $adminLogin->name }}
                        </span>
