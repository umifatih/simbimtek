    ...
    <section class="relative overflow-hidden bg-[radial-gradient(ellipse_90%_60%_at_50%_-10%,rgba(15,42,67,0.07),transparent)] pb-8 pt-8 sm:pb-10 sm:pt-12 lg:pb-14 lg:pt-16">
        ...
        <div class="relative mx-auto max-w-3xl px-5 sm:px-6 lg:px-8">
            <nav class="flex items-center gap-2 text-xs text-ink/50">
                ...
                <span>/</span>
                <span class="font-medium text-ink-900">Cara Kerja</span>
            </nav>
                ...
                @php
                    $fase = [
                        [
                            ...
                            'judul' => 'Daftar online',
                            'durasi' => '± 5 menit',
                            'desc' => 'Pilih kegiatan, isi data diri (Unit Kerja, Nama & Gelar, NIP, Jabatan, dan data Kepala Sekolah). Tidak perlu unggah berkas apa pun.',
                        ...
                        [
                            ...
                            'durasi' => 'Instan',
                            'desc' => 'Begitu formulir dikirim, Surat Tugas dan SPPD otomatis dibuat dari data yang kamu isi dan langsung bisa diunduh — tanpa menunggu.',
                        ...
                        [
                            'no' => '03',
                            'judul' => 'Verifikasi admin (berjalan di belakang layar)',
                            'durasi' => '1–2 hari kerja',
                            'desc' => 'Panitia memeriksa kebenaran data yang kamu kirim. Ini tidak menahan unduhan dokumenmu — cuma untuk validasi rekap peserta.',
                    ...
                    @php
                        $faq = [
                            ...
                            [
                                ...
                                'a' => 'Langsung, begitu formulir pendaftaran dikirim. Tidak perlu menunggu verifikasi admin selesai.',
                            ],
                            [
