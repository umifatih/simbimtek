{{-- resources/views/admin/cetak/daftar-hadir.blade.php --}}
...
@section('content')
    ...
    <table class="mt-6 w-full border-collapse text-sm">
        <thead>
            <tr class="border-b-2 border-ink-900 text-left text-xs font-semibold uppercase tracking-wide text-ink-900">
                ...
                <th class="w-28 py-2.5">Hari 1</th>
                <th class="w-28 py-2.5">Hari 2</th>
                <th class="w-28 py-2.5">Hari 3</th>
            </tr>
        </thead>
        <tbody>
    ...
    <p class="mt-4 text-xs text-ink/45">Kolom tanda tangan diisi manual oleh peserta saat check-in setiap hari.</p>
